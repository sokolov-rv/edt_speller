...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// DEV_Подсистемы.YandexSpeller
	DEV_YandexSpeller.ПриСозданииНаСервере(ЭтаФорма);
	// Конец DEV_Подсистемы.YandexSpeller
...
Процедура ПроверитьТекстНаСервере(Знач ТекстовоеСодержимое)
	...
	Правописание = Обработки.DEV_YandexSpeller.Создать();
